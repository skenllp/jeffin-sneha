...
(function () {
  ...
  /* ---------- Countdown timer ---------- */
  // Betrothal date: 18 October 2026, 12:00 Noon
  var WEDDING_DATE = new Date("2026-10-18T12:00:00");
...
(function () {
  ...
  /* ------------------------------------------------------------------
     1. LETTER STAGGER — split "Sneha" and "Jeffin" into individual
  ...
  buildLetters("gateName1", "Sneha",  1.9);
  buildLetters("gateName2", "Jeffin", 2.6);
